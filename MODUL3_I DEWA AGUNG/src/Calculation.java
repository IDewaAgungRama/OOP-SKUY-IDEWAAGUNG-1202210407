public class Calculation implements Runnable {
  ...
  public void setSquare(double side) throws IllegalArgumentException {
    if (side < 1) {
      throw new IllegalArgumentException("Sisi harus lebih besar dari/sama dengan satu ");
    }
    this.area = side * side;
  }
  ...
  public void setCircle(double radius) throws IllegalArgumentException {
    if (radius < 1) {
      throw new IllegalArgumentException("Radius harus lebih besar dari/sama dengan satu");
    }
  ...
  public void setTrapezoid(double a, double b, double t) throws IllegalArgumentException {
    if (a < 1 || b < 1 || t < 1) {
      throw new IllegalArgumentException("sisi dan tinggi harus lebih dari/sama dengan satu");
    }
    this.area = ((a + b) * t) / 2;
  }
